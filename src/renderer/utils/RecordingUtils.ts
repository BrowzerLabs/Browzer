    ...
    switch (action.type) {
      case 'click':
        return {
          ...
          description: `Text: ${action.element?.text}` + (action.element?.value ? ` | ${action.element?.value}` : '') + (action.element?.href ? ` | ${action.element?.href}` : ''),
      ...
      case 'type': {
        return {
          ...
          description: `${action.element?.text} | ${action.element?.value}`,
