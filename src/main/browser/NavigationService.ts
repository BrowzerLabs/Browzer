...
export class NavigationService {
  ...
  constructor(
    ...
    this.searchEngineId =
      this.settingsService.getSetting('general', 'searchEngineId') || 'google';
  ...
  public async getAutocompleteSuggestions(
    ...
    const historySuggestions =
      await this.historyService.getAutocompleteSuggestions(trimmedQuery, 6);
